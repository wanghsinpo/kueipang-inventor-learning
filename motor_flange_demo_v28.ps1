...
param(
    ...
    [double]$PlateT       = 14.0,
    [double]$Chamf        = 14.0,
    [double]$HubD         = 55.0,    # v12: was 50, photo shows slightly larger
    [double]$HubH         = 10.0,   # v13: 8→10 — photo iso shows taller hub
    [double]$CBD          = 47.0,    # v12: was 42, scales with HubD
    [double]$CBDepth      = 4.0,
    [double]$BoreD        = 32.0,    # v22: was 32, try smaller bore
    [double]$PocketOD     = 73.0,    # v12: was 68, scales with HubD
