...
$realF = "$env:USERPROFILE\Desktop\test\round17_KE-SP-008_ESR_MP_big\real.ipt"
...
$doc.SaveAs("$env:USERPROFILE\Desktop\test\round17_KE-SP-008_ESR_MP_big\my_attempt.ipt", $false)
