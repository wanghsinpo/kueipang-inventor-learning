...
$realF = "$env:USERPROFILE\Desktop\test\round21_motor_copper_gasket\real.ipt"
...
$doc.SaveAs("$env:USERPROFILE\Desktop\test\round21_motor_copper_gasket\my_attempt.ipt", $false)
