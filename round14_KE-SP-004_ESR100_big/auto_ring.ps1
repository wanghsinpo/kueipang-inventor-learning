...
$realF = "$env:USERPROFILE\Desktop\test\round14_KE-SP-004_ESR100_big\real.ipt"
...
$doc.SaveAs("$env:USERPROFILE\Desktop\test\round14_KE-SP-004_ESR100_big\my_attempt.ipt", $false)
