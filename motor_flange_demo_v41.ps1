...
param(
    [double]$PlateW       = 75.0,
    [double]$PlateH       = 75.0,    # v12: was 80, photo shows more square
    [double]$PlateT       = 12.0,
    [double]$Chamf        = 10.0,
    [double]$HubD         = 44.0,    # v12: was 50, photo shows slightly larger
    [double]$HubH         = 10.0,   # v13: 8→10 — photo iso shows taller hub
    [double]$CBD          = 38.0,    # v12: was 42, scales with HubD
    [double]$CBDepth      = 4.0,
    [double]$BoreD        = 27.0,    # v22: was 32, try smaller bore
    [double]$PocketOD     = 58.0,    # v12: was 68, scales with HubD
