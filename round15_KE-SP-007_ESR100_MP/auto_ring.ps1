...
$realF = "$env:USERPROFILE\Desktop\test\round15_KE-SP-007_ESR100_MP\real.ipt"
...
$doc.SaveAs("$env:USERPROFILE\Desktop\test\round15_KE-SP-007_ESR100_MP\my_attempt.ipt", $false)
