...
$realF = "$env:USERPROFILE\Desktop\test\round13_KE-SP-003_ESR100\real.ipt"
...
$doc.SaveAs("$env:USERPROFILE\Desktop\test\round13_KE-SP-003_ESR100\my_attempt.ipt", $false)
